    ...
    const freeProjects = [
      {
        ...
        settings: {
          isPublic: false,
          allowMemberInvites: false,
          timeTracking: { enabled: false, requireApproval: false },
          notifications: {
            taskUpdates: true,
    ...
    const proProjects = [
      {
        ...
        description:
          "Build scalable e-commerce solution with React and Node.js",
        workspace: "pro-ws-1",
      ...
      },
      {
        ...
        settings: {
          isPublic: false,
          allowMemberInvites: true,
          timeTracking: { enabled: true, requireApproval: true },
          notifications: {
            taskUpdates: true,
            milestoneReminders: true,
            deadlineAlerts: true,
  ...
  const handleBypassUltra = () => {
    ...
    const ultraProjects = [
      ...
      },
      {
        ...
        description:
          "Migrate entire infrastructure to cloud-native architecture",
        workspace: "ultra-ws-1",
        createdBy: "ultra-bypass",
        status: "planning" as const,
        priority: "high" as const,
