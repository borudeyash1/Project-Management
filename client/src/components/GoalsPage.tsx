          ...
          {goalStats && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600">{t('goals.inProgress')}</p>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600">{t('goals.avgProgress')}</p>
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`p-2 rounded ${viewMode === mode.id ? 'bg-purple-100 text-purple-600' : 'text-gray-600 hover:bg-gray-100'}`}
                      >
            ...
            <div className="p-4">
              {viewMode === 'grid' && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredGoals.map(goal => (
                    <div key={goal._id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer" onClick={() => setSelectedGoal(goal)}>
              ...
              {viewMode === 'list' && (
                <div className="divide-y divide-gray-200">
                  {filteredGoals.map(goal => (
                    <div key={goal._id} className="p-4 hover:bg-gray-50 cursor-pointer" onClick={() => setSelectedGoal(goal)}>
          ...
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{selectedGoal.title}</h3>
                  <p className="text-gray-600 mb-3">{selectedGoal.description}</p>
            ...
            <div className="p-6 space-y-6">
              {/* Progress */}
              <div>
                <h4 className="text-lg font-medium text-gray-900 mb-3">{t('goals.progress')}</h4>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">{t('goals.overallProgress')}</span>
              ...
              {selectedGoal.milestones && selectedGoal.milestones.length > 0 && (
                <div>
                  <h4 className="text-lg font-medium text-gray-900 mb-3">{t('goals.milestones')}</h4>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{selectedGoal.createdBy.fullName}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">{t('goals.categoryLabel')}</label>
                  <p className="text-sm text-gray-900 capitalize">{t(`goals.category.${selectedGoal.category}`)}</p>
                </div>
              </div>
