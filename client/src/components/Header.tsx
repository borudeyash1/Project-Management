  ...
  return (
    <header className="h-14 bg-white border-b border-border flex items-center justify-between px-4 sm:px-6">
      <div className="flex items-center gap-3">
        <button 
          className="p-2 rounded-lg border border-border hover:bg-slate-50 md:hidden"
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="relative">
            ...
            <input 
              type="text" 
              className="w-64 rounded-lg border border-border bg-white pl-9 pr-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500" 
        ...
        <div className="relative">
          <button 
            className="flex items-center gap-2 p-2 rounded-lg border border-border hover:bg-slate-50"
            ...
            <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-border rounded-lg shadow-lg z-50">
              <div className="p-4 border-b border-border">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <div className="font-medium">{state.userProfile.fullName}</div>
                    <div className="text-sm text-slate-500">{state.userProfile.email}</div>
                  </div>
                </div>
              </div>
