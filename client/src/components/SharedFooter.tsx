...
const SharedFooter: React.FC = () => {
  ...
  return (
    <footer className={`bg-gradient-to-b from-[#1e3a5f] to-[#0f2744] mt-auto shadow-2xl border-t border-blue-900/50`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className={`text-gray-300 space-y-3`}>
              <div className="flex items-center gap-3 hover:text-[#fcdd05] transition-colors duration-200">
                <div className={`w-8 h-8 bg-[#44a0d1]/20 rounded-lg flex items-center justify-center`}>
          ...
          <div>
            ...
            <ul className={`space-y-3 text-gray-300`}>
              <li>
                <Link 
                  to="/" 
                  className={`hover:text-[#fcdd05] transition-colors duration-200 flex items-center gap-2 text-sm font-medium`}
                >
                  <Home size={16} />
                  {t('footer.home')}
                </Link>
          ...
          <div>
            ...
            <ul className={`space-y-3 text-gray-300 text-sm`}>
              ...
              <li className="flex items-center gap-2">
                <div className={`w-1.5 h-1.5 bg-[#fcdd05] rounded-full`}></div>
        ...
        <div className={`border-t border-blue-900/50 mt-12 pt-8`}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              <a 
                href="#" 
                className={`text-gray-400 hover:text-[#fcdd05] transition-colors duration-200 font-medium`}
              >
