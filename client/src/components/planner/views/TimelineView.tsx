      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
            <div className="flex">
              <div className="w-48 flex-shrink-0 px-4 py-3 border-r border-gray-200 dark:border-gray-700">
                ...
                <div className="flex h-full">
                  {timelineDates.map((date, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className={`flex-1 px-2 py-3 text-center border-r border-gray-200 dark:border-gray-700 ${
