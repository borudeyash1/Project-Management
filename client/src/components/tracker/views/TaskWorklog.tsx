    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        {Object.values(taskGroups).map((group: any) => {
          ...
          return (
            <div key={group.taskId || 'no-task'} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  {group.projectName && (
                    <p className="text-sm text-gray-600 dark:text-gray-400">{group.projectName}</p>
                  )}
                </div>
              ...
              <div className="space-y-2">
                {group.entries.map((entry: any) => (
                  <div key={entry._id} className="flex items-center justify-between py-2 border-t border-gray-100 dark:border-gray-700">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {entry.notes && (
                          <div className="text-xs text-gray-600 dark:text-gray-400">{entry.notes}</div>
                        )}
                      </div>
                    </div>
