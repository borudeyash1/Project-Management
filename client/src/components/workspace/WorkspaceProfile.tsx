    ...
    return (
      <div className="p-6">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 text-center">
          <p className="text-gray-600 dark:text-gray-300">Select a workspace to view profile details.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 space-y-6">
      <div className="grid gap-6 md:grid-cols-2">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 space-y-4">
          <div>
            <p className="text-sm uppercase text-gray-500 dark:text-gray-400 tracking-wide">Workspace</p>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{currentWorkspace.name}</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">{currentWorkspace.description || 'No description provided.'}</p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm uppercase text-gray-500 dark:text-gray-400 tracking-wide">Role selector</p>
          ...
          <button
            ...
            className="w-full px-4 py-3 rounded-xl bg-gray-900 text-white dark:bg-blue-600 dark:hover:bg-blue-500 hover:bg-gray-800 transition-colors"
          >
            Open selected view
          </button>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-900">
            <p className="text-sm text-gray-500 dark:text-gray-400">Workspace type</p>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
