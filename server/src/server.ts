...
import sartthiAccountsRoutes from "./routes/sartthiAccountsRoutes";
import sartthiDataRoutes from "./routes/sartthiDataRoutes";
...
import sartthiIntegrationsRoutes from "./routes/sartthi-integrations";
...
app.use("/api/sartthi-accounts", sartthiAccountsRoutes);
app.use("/api/sartthi-data", sartthiDataRoutes);
...
app.use("/api/sartthi-integrations", sartthiIntegrationsRoutes);
