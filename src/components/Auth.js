        ...
        <div className="w-full max-w-md">
          ...
          {authTab === 'login' && (
            <form className="bg-white border border-border rounded-xl p-5 space-y-4" onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                className="w-full px-3 py-2 rounded-lg text-white text-sm font-medium hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 shadow-sm bg-primary"
              >
                Continue
              </button>
